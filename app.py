...
# Set Groq API Key
# load_dotenv() was already called above; no need to import or call again

# Read the key from the environment (or .env file via load_dotenv)
groq_key = os.getenv("GROQ_API_KEY")

if not groq_key:
    raise ValueError("GROQ_API_KEY not found in environment variables")

# export it so downstream libraries find it
